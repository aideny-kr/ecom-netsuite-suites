    ...
    return (
        <div className="flex flex-col items-center justify-center p-6 bg-background rounded-lg border border-border/50 shadow-sm relative overflow-hidden">
            ...
            <div className="relative flex items-center justify-center h-20 w-20 mb-4">
                ...
                />
                {/* Inner fast spinning multi-colored ring (Monochrome + Punch colors) */}
                <motion.div
                    className="absolute inset-2 rounded-full border-[3px] border-t-primary border-r-accent border-b-muted-foreground border-l-transparent"
                    animate={{ rotate: -360 }}

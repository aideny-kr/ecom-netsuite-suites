...
import { LearnedRulesSection } from "@/components/memory/learned-rules-section";
    ...
    <div className="animate-fade-in space-y-8 p-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[13px] text-muted-foreground">
            What the assistant has learned about your business — confirmable concepts and the
            rules it follows on every chat turn.
          </p>
        </div>
      </div>
      ...
      <Tabs defaultValue="graph" className="space-y-6">
        <TabsList>
          ...
          <TabsTrigger value="rules">Learned Rules</TabsTrigger>
        </TabsList>

...
// Carries the webapp's design tokens (frontend/tailwind.config.ts) so the reused
// data-frame-table card renders with identical styling. Only the token surface
// the card + chat shell reference is included.
const config: Config = {
  darkMode: ["class"],
  content: ["./src/**/*.{ts,tsx}"],
  theme: {

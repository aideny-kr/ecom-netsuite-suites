    ...
    def system_prompt(self) -> str:
        ...
        if getattr(self, "_transaction_workflow", False):
            parts.append(
                ...
                "to locate a group, then transaction_ops_accounting_group for scoped accounting-group work "
                "or transaction_ops_accounting_evidence for a case. Resolve connections from that authorized evidence; "

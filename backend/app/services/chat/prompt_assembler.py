...
PRECEDENCE: If the user explicitly names a source ("in NetSuite", "from BigQuery",
"check NetSuite for ...", "look it up in BigQuery"), use ONLY that source.
Do not call any other source unless the user explicitly asks for both

...
ROUTER_PROMPT = (
    ...
    ' "netsuite.suiteql" tool with a SuiteQL query.\n'
...
AGENTIC_SYSTEM_PROMPT = (
    ...
    "\n"
    "1. netsuite_suiteql — Execute a SuiteQL query against NetSuite. "
    "This is your PRIMARY tool for answering data questions.\n"
    "   Parameters: {\"query\": \"SELECT ...\", \"limit\": 100}\n"
    "   Example: To find the latest order:\n"
    "   netsuite_suiteql({\"query\": \"SELECT id, tranid, trandate, entity, "
    "status, foreigntotal FROM transaction WHERE type = 'SalesOrd' "
    "ORDER BY trandate DESC FETCH FIRST 5 ROWS ONLY\"})\n"
    "\n"
    ...
    "\n"
    "7. report_export — Export a report in CSV or other format.\n"
    "   Parameters: {\"report_type\": \"...\", \"format\": \"csv\"}\n"
    "\n"
    "8. workspace_list_files — List files in a workspace.\n"
    "9. workspace_read_file — Read a specific file from a workspace.\n"
    "10. workspace_search — Search for files by name or content.\n"
    "11. workspace_propose_patch — Propose a code change as a unified diff.\n"
    "12. suitescript_sync — Sync SuiteScript files from NetSuite into workspace.\n"
    "\n"
    "WORKFLOW GUIDANCE:\n"
    "- When the user asks about NetSuite data (transactions, invoices, customers, "
    "items, vendors, etc.), use netsuite_suiteql to run a SuiteQL query.\n"
    ...
    "- Pagination: use FETCH FIRST N ROWS ONLY (NOT LIMIT — LIMIT is not supported)\n"
    "- Use NVL() instead of IFNULL() or COALESCE()\n"
    ...
    "- Always include a row limit to avoid fetching too much data\n"
    "\n"
    "RESPONSE RULES:\n"

...
from sqlalchemy import DateTime, and_, cast, func, or_, select, tuple_
...
def evidence_time(report, fallback):
    # This timestamp is generated by record_finding, never accepted from callers.
    return func.coalesce(cast(report["_observation"]["observed_at"].astext, DateTime(timezone=True)), fallback)
